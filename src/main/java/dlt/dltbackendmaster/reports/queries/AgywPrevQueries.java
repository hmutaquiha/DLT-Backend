...
public class AgywPrevQueries {
	...
	public static final String TOTAL_NEWLY_ENROLLED_AGYW_AND_SERVICES_SUMMARY= ""
			+ "select provincia,\n"
			+ "	distrito,\n"
			+ "	nui, \n"
			+ "	idade_actual,\n"
			...
			+ "		from agyw_prev_mview\n"
			+ "		where intervention_date between '2022-09-21' and '2023-08-31'		\n"
			+ "		and intervention_status = 1\n"
			...
			+ "	left join neighborhood n on v.neighborhood_id = n.id\n"
			+ "	left join partners pa on v.organization_id = pa.id\n"
			+ "	where v.intervention_date <= '2023-08-31'\n"
			+ "	-- and v.vulneravel=1\n"
