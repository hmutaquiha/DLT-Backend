...
public class ReferencesServices implements java.io.Serializable {
	...
	public ReferencesServices(ReferencesServicesId id, References references, int status, int createdBy,
			Date dateCreated) {
		this.id = id;
	...
	public ReferencesServices(ReferencesServicesId id, References references, String description, int status,
