...
public class Account extends Users implements Serializable, UserDetails {
	...
	public Account(int id, Locality locality, Partners partner, Profiles profiles, Set<Province> provinces, Set<District> districts, String surname, String name,
		...
		super(id, partner, profiles, provinces, districts, surname, name,
	...
	public Account(Users user) {
		super(user.getId(), user.getPartners(), user.getProfiles(), user.getProvinces(), user.getDistricts(), user.getSurname(),
	...
	public Users toUser() {
		...
		return new Users(getId(), getPartners(), getProfiles(), getProvinces(), getDistricts(), 
