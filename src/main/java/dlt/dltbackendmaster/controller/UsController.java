...
public class UsController {
	...
	public ResponseEntity<List<Us>> getByUsType(@PathVariable Integer typeId,
			@PathVariable List<Integer> localitiesIds) {
	...
	public ResponseEntity<List<Us>> getByUsUser(@PathVariable Integer userId, @PathVariable Integer typeId) {
		...
		try {
			...
			if (user.getLocalities().size() > 0) {
				...
				List<Us> us = service.GetAllEntityByNamedQuery("Us.findByEPLocalities", localitiesId,
				...
				List<Us> us = service.GetAllEntityByNamedQuery("Us.findByEPDistrict", districtsId,
						String.valueOf(typeId));
				return new ResponseEntity<>(us, HttpStatus.OK);
				...
				List<Us> us = service.GetAllEntityByNamedQuery("Us.findByEPProvince", provincesId,
						String.valueOf(typeId));
				return new ResponseEntity<>(us, HttpStatus.OK);
