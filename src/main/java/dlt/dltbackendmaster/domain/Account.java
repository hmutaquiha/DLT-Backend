...
public class Account extends Users implements Serializable, UserDetails {
	...
	public Account(int id, Locality locality, Partner partner, Profiles profiles, Us us, String surname, String name,
	...
	public Account(Users user) {
		super(user.getId(), user.getLocality(), user.getPartner(), user.getProfiles(), user.getUs(), user.getSurname(),
